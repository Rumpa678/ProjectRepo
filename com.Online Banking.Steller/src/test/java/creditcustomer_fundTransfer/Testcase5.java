		        ...
		        //get text account no
		         ...
		         if(account.contains("Account Created Successfully")) {
		        	...
		        	driver.findElement(By.xpath("//a[.='Staff Login']")).click();
		             ...
		             if(pro1url.contains("staff_profile.php"))
		             {
		             	System.out.println("staff Profile page is displayed");
		             }
		             else {
		             ...
		             if(cust.contains("view_customer_by_acc_no.php")) {
		            	 System.out.println("view customer account by a/c number page is displayed");
		             }
		             else {
		            	 System.out.println("view customer account by a/c number page not displayed");
		             }
		             //covert and fetch account no 
		        	 String[] txt1 = account.split(" ");
		        	 String accountno = txt1[4].substring(1,14);
		        	 System.out.println("Account number---"+accountno);
		        	 
		             
		             //enter account number
		             WebElement custid = driver.findElement(By.name("account_no"));
		             custid.click();
		             custid.sendKeys(accountno);
